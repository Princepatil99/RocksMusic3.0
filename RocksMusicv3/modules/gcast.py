...
from RocksMusicv3.config import SUDO_USERS, BOT_TOKEN
from pyrogram.errors import UserAlreadyParticipant

from RocksMusicv3.services.callsmusic.callsmusic import client as USER
...
async def broadcast(_, message: Message):
    ...
    if message.from_user.id not in SUDO_USERS:
        ...
        if not message.reply_to_message:
            await wtf.edit("Pʟᴇᴀsᴇ ʀᴇᴘʟᴀʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ ᴛᴏ Bʀᴏᴀᴅᴄᴀsᴛ...!")
            return
