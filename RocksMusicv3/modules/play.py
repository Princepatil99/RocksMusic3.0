...
from RocksMusicv3.config import ARQ_API_KEY
from RocksMusicv3.config import BOT_NAME as bn
from RocksMusicv3.config import DURATION_LIMIT
from RocksMusicv3.config import UPDATES_CHANNEL as updateschannel
from RocksMusicv3.config import que
from RocksMusicv3.function.admins import admins as a
from RocksMusicv3.helpers.admins import get_administrators
from RocksMusicv3.helpers.channelmusic import get_chat_id
from RocksMusicv3.helpers.errors import DurationLimitError
...
from RocksMusicv3.helpers.gets import get_file_name
...
from RocksMusicv3.services.downloaders import youtube
...
def cb_admin_check(func: Callable) -> Callable:
    async def decorator(client, cb):
        ...
        if cb.from_user.id in admemes:
            ...
            await cb.answer("**Sᴡᴇᴇᴛ ʜᴇᴀʀᴛ ᴀᴘᴋᴏ ᴘᴇʀᴍᴇssɪᴏɴ ɴᴀɪ Hᴀɪ..❤️", show_alert=True)
            return
...
async def playlist(client, message):
    ...
    if not queue:
        await message.reply_text("Iᴅʟᴇ Pʟᴀʏᴇʀ")
    temp = []
    for t in queue:
        temp.append(t)
...
async def ee(client, message):
    ...
    if stats:
        ...
        await message.reply("**Bɪɴᴀ Gᴜᴛʜʟɪ ᴋɪ ᴋʜᴀᴊᴏᴏʀ ᴘᴇʜʟᴇɢ ᴠᴄ ᴏɴ Kᴇʀ**")
...
async def settings(client, message):
    ...
    if stats:
        ...
        await message.reply("Tᴜʀɴᴇᴅ ᴏɴ ᴠᴄ Fɪʀsᴛ👇")
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/b15b45e4f353232ca80b5.png"
        ...
        try:
            ...
            await lel.edit("**Pʟᴀʏɪɴɢ Pʟᴇᴀsᴇ Wᴀɪᴛ...**.")
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"#⃣ **Yᴏᴜʀ sᴏɴɢ ɪs ᴀᴛ ɪɴ ᴡᴀɪᴛɪɴɢ ᴘᴏsɪᴛɪᴏɴ** {position}!",
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ <b>Playing</b> here the song requested by **My Love** {} via **Rocks Server** 😎".format(
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @RocksMusicv3 to your Group and try again manually request here @AwesomeSupport with your group link</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
