...
from RocksMusicv4.config import DURATION_LIMIT
from RocksMusicv4.modules.play import arq
...
def song(client, message):
    ...
    for i in message.command[1:]:
        query += " " + str(i)
    print(query)
    m = message.reply("🔎 **Fɪɴᴅɪɴɢ ᴛʜᴇ Sᴏɴɢ**...")
    ...
    try:
        ...
        m.edit("❌ **Nᴏᴛʜɪɴɢ Fᴏᴜɴᴅ...**🤔\n\n Dᴇᴀʀ ᴛʀʏ ᴀɴᴏᴛʜᴇʀ ᴋᴇʏᴡᴏʀᴅ ᴛʜᴇɴ ɪ ᴡɪʟʟ ʜᴇʟᴘ ʏᴏᴜ...")
        print(str(e))
        return
    m.edit("Dᴏᴡɴʟᴏᴀᴅɪɴᴅ ᴛʜᴇ sᴏɴɢ...")
    try:
        with youtube_dl.YoutubeDL(ydl_opts) as ydl:
            info_dict = ydl.extract_info(link, download=False)
            audio_file = ydl.prepare_filename(info_dict)
            ydl.process_info(info_dict)
        rep = "**🎵 Uᴘʟᴏᴀᴅᴇᴅ ʙʏ ʀᴏᴄᴋs Pʀᴏᴊᴇᴄᴛ**"
