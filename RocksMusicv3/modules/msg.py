...
from RocksMusicv3.config import ASSISTANT_NAME, PROJECT_NAME
...
*) If userbot joined enjoy music, If not add @{ASSISTANT_NAME} to your group and retry © @Dr_Asad_Ali
