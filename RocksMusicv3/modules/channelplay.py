...
from RocksMusicv3.modules.play import generate_cover
from RocksMusicv3.modules.play import arq
from RocksMusicv3.modules.play import cb_admin_check
from RocksMusicv3.modules.play import transcode
from RocksMusicv3.modules.play import convert_seconds
from RocksMusicv3.modules.play import time_to_seconds
from RocksMusicv3.modules.play import changeImageSize
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @RocksMusicv3 to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
